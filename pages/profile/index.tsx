    ...
    <AppDrawer>
      ...
      <div className={classes.Section}>
        ...
        <div className={classes.Section_General}>
          <Avatar
            className={classes.Section_Avatar}
          >
            {getUserInitial(user)}
          </Avatar>
          <form className={clsx(classes.Section_Form, classes.Section_General_Form)} onSubmit={onSubmit}>
            <FormControl margin="dense">
              <label className={classes.Section_Form_Label}>FIRST NAME</label>
              <OutlinedInput onChange={onChange} type="text" name="first_name" value={userData.first_name} />
              <FormHelperText error={!!errors.first_name}>{errors.first_name}</FormHelperText>
            </FormControl>
            <FormControl margin="dense">
              <label className={classes.Section_Form_Label}>LAST NAME</label>
              <OutlinedInput onChange={onChange} type="text" name="last_name" value={userData.last_name} />
              <FormHelperText error={!!errors.last_name}>{errors.last_name}</FormHelperText>
            </FormControl>
            <FormControl margin="dense">
              <label className={classes.Section_Form_Label}>EMAIL</label>
              <OutlinedInput onChange={onChange} type="email" name="email" value={userData.email} required />
      ...
      <div className={classes.Section}>
        ...
        <form className={classes.Section_Form} onSubmit={onPasswordSubmit}>
          <FormControl margin="dense">
            <label className={classes.Section_Form_Label}>CURRENT PASSWORD</label>
            <OutlinedInput onChange={onChange} type="password" name="current" value={passwords.current} required />
            <FormHelperText error={!!errors.current}>{errors.current}</FormHelperText>
          </FormControl>
          <FormControl margin="dense">
            <label className={classes.Section_Form_Label}>NEW PASSWORD</label>
            <OutlinedInput onChange={onChange} type="password" name="new" value={passwords.new} required />
